...
public:
    MOCK_METHOD(SetChargingProfileResponse, validate_and_add_profile,
                (const ChargingProfile& profile, int32_t evse_id, AddChargingProfileSource source_of_request));
    ...
    MOCK_METHOD(SetChargingProfileResponse, add_profile, (const ChargingProfile& profile, int32_t evse_id));
