...
TEST_F(DatabaseHandlerTest, GetChargingProfilesMatchingCriteria_NoCriteriaReturnsAll) {
    ...
    std::vector<std::tuple<int, v201::ChargingProfile, ChargingLimitSourceEnum>> sut =
...
TEST_F(DatabaseHandlerTest, GetChargingProfilesMatchingCriteria_IfProfileIdAndEvseIdGiven_ReturnsMatchingProfile) {
    ...
    EXPECT_THAT(sut, testing::Contains(testing::FieldsAre(testing::_, profile_2, testing::_)));
}
...
TEST_F(DatabaseHandlerTest, GetChargingProfilesMatchingCriteria_MatchingProfileIds_ReturnsEVSEAndSource) {
    ...
    EXPECT_THAT(sut, testing::Contains(testing::FieldsAre(DEFAULT_EVSE_ID, profile_1, ChargingLimitSourceEnum::CSO)));
    EXPECT_THAT(sut, testing::Contains(testing::FieldsAre(STATION_WIDE_ID, profile_2, ChargingLimitSourceEnum::EMS)));
}
